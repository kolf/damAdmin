...
export const API_CONFIG = {
  ...
  activeProduct: 'damProduct/active?token=' + token,        //激活产品
  createProduct: 'damProduct/create?token=' + token,     //创建产品
  getProduct:'damProduct/view?token=' + token,            //查看产品
  ...
  toggleActive: 'damUser/activeState?token=' + token,           //查询普通功能
};
